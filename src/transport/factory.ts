...
import { SecureMcpTunnelClient, type SecureMcpTunnelOptions } from "../tunnel/secure-mcp.js";
...
export function createTunnelProvider(config: TunnelTransportConfig): TunnelProvider {
  if (config.kind === "secure-mcp") return new SecureMcpTunnelClient(config.secureMcp);
